...
class WorldModel:
    ...
    def export_env_mesh(self) -> dict[str, Any]:
        verts, faces = self.tsdf.extract_mesh()
        return {"vertices": int(verts.shape[0]), "faces": int(faces.shape[0])}
    ...
    def serialize_state(self) -> dict[str, Any]:
        return {
            ...
            "voxel_size": self.occupancy.voxel_size,
